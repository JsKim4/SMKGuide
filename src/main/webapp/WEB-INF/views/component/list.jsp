	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<table
					class="table table-striped table-bordered table hover componentTable">
					<thead>
						<tr>
							<th width="10%">번호</th>
							<th width="90%">이름</th>
					...
					<c:forEach items="${list}" var="component">
						<tr>
							<sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_MANAGE')">
								<td width="10%"><a class="move"
									href='<c:out value="${component.id }" />'> <c:out
											value="${component.id }" /></a></td>
							</sec:authorize>
							<sec:authorize access="!hasAnyRole('ROLE_ADMIN','ROLE_MANAGE')">
								<td width="10%"><c:out value="${component.id }" /></td>
							</sec:authorize>
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/resources/js/component.js?ver=13"></script>
<script type="text/javascript">
	$(document)
			.ready(
					function() {
